...
class Orb {
    ...
    setBounds() {
        ...
        const originY = window.innerWidth < 1000 ? window.innerHeight : window.innerHeight / 1.575;
...
// Animate!
if (!window.matchMedia('(prefers-reduced-motion: reduce)').matches) app.ticker.add(()=>{
...
else // perform one update and render per orb, do not animate
orbs.forEach((orb)=>{
    orb.update();
    orb.render();
});
...
//# sourceMappingURL=index.b2d9dab9.js.map
